...
const Home = () => {
	...
	return (
		<div
			className={`flex flex-col items-center justify-center min-h-screen p-8 bg-gradient-to-br from-blue-100 to-purple-100 ${inter.className}`}
		>
				...
				<div className='mt-12 flex justify-between items-center'>
					...
					>
						{isLoading ? (
							...
							<>
								Generate Topic
								<span role='img' aria-label='Brain' className='ml-2'>
									🤯
								</span>
							</>
						)}
